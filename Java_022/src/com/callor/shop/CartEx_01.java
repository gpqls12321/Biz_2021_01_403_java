...
public class CartEx_01 {
	...
	public static void main(String[] args) {
		...
		MenuServiceImplV1 ms = new MenuServiceImplV1(); // 클래스로 선언, 클래스로 생성
		// 위 아래 둘 다 상관없음
		MenuService mService = new MenuServiceImplV1(); // 인터페이스로 선언, 클래스로 생성
														// 인터페이스를 implements 하여 작성된 클래스는 인터페이스로 선언 하자. => 코드 업그레이드가 비교적
														// 쉬워지는 편
