...
public class IntegerEx_01 {
	...
	public static void main(String[] args) {
		...
		// 문자열형숫자(str1 담긴 값)을 정수로 변환하여 return 하고 정수형변수 num1에 저장한다
		...
		int num3 = Integer.valueOf("30"); // 정수 30저장
		num3 = Integer.valueOf("03"); // 정수 3 저장
		num3 = Integer.valueOf("300"); // 정수 300저장
