...
public class StringEQ_01 {
	...
	public static void main(String[] args) {
		...
		Integer num4 = new Integer(30); // 맞는 코드지만 java 9 이후에서는 사용 금지
		Integer num5 = 30;
		Integer num6 = 30;
		...
		System.out.println(num6 == (int)num7); //-> 이런식으로 형변환해서 해야댐
		...
		// 문자열 변수를 클래스 방식으로 선언하면 == 연산으로 비교가 불가능함
		 ...
		 * false 결과가 나기도 한다.
		 * 만약 코드 중간에 어떤이유로 이러한 현상이 발생한다면
		 * if(문자열 변수 == "문자열") 과 같은 코드에서 예측할 수 없는 논리적 오류가 발생할 것이다.
		 * 
