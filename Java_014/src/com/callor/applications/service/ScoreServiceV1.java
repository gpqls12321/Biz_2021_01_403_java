...
public class ScoreServiceV1 {
	...
	public void init() {
		...
		//scanner 와 random 을 선언과 분리하여 생성하는 코드를 작성함
		scan = new Scanner(System.in);
		rnd = new Random();

		System.out.println("몇 명의 성적을 처리할 거?");
	...
	public void makeNamesAndArrayInit() {
		strName = new String[] {
				"홍길동", "이몽룡","성춘향","장록수","임꺽정","김태연","설운도","장윤정"
		};
	...
	public void makeScore() {
		rnd = new Random(); // rnd.nextInt() method 를 호출하기 전에 반드시 어디에선가 실행되어야 한다.
		for(int i = 0 ; i < strName.length ; i++) {
